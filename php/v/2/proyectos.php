...
<div class="container px-6 mx-auto grid">
    ...
    if($total_proyecto > 0){
        ...
        <a class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800" href="generar_pdf.php?id=<?php echo $row_proyecto[$i]['id_proyecto'] ?>" target="_blank">
