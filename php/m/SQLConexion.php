...
//     private $clave='';
//     private $bd='bexpress_globeria_app';


	private $server='localhost';
    private $usuario='root';
    private $clave='';
    private $bd='utnc_foncyt';
	...
	public function obtenerDatos($QueryString){
		$this->conectar();	
	...
	public function actualizarDatos($QueryString){
		$this->conectar();
	...
	public function retornarID($QueryString1){
		$this->conectar();
